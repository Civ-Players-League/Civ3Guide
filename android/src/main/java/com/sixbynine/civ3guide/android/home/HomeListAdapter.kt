...
class HomeListAdapter : RecyclerView.Adapter<HomeListAdapter.ViewHolder>() {
  ...
  override fun onBindViewHolder(holder: ViewHolder, position: Int) {
    ...
    holder.rootView.setOnClickListener { navigateToDistination(it.context, destination) }
  }

  override fun getItemCount() = destinations.size

  private fun navigateToDistination(context: Context, destination: HomeDestination) {
